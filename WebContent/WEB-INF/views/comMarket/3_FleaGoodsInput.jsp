				...
				<div class="panel-body">
					...
					<form class="form-horizontal" role="form">
							...
							<div class="col-sm-10">
								<div class="radio custom-radio">
									<label><input type="radio" name="radio1"
										...
										type="radio" name="radio1"> <span class="fa fa-circle"></span>
										food </label> </label> <label><input type="radio" name="radio1">
										<span class="fa fa-circle"></span> cosmetics </label> </label> <label><input
										type="radio" name="radio1"> <span class="fa fa-circle"></span>
										child </label> </label> <label><input type="radio" name="radio1">
										<span class="fa fa-circle"></span> others </label>
								</div>
							</div>
						</div>
						...
						<div id="sumbtn" class="col-md-12">
							...
							<div class="col-md-6">
								<a href="/Yolo/mypage/myReg/MarketMyList.myreg"
